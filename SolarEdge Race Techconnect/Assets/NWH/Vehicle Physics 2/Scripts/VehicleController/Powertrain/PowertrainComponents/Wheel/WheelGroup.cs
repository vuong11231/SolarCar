...
namespace NWH.VehiclePhysics2.Powertrain.Wheel
{
    ...
    public partial class WheelGroup
    {
        ...
        /// </summary>
        [Tooltip("Should Ackerman steering angle be added to the axle? Angle is auto-calculated.")]
        ...
        public void CalculateCamber()
        {
            if (isSolid && Wheels.Count == 2) // Calculate and set solid axle camber
            {
                ...
                float camberAngle = VehicleController.CalculateSignedCentralAngle(_vc.transform.right, _direction, _vc.transform.forward);
