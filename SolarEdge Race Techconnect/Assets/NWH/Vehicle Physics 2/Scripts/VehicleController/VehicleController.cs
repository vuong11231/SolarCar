    ...
    public partial class VehicleController : Vehicle
    {
        ...
        public void UpdateInertiaTensor(float xCoeff = 1f, float yCoeff = 1f, float zCoeff = 1f)
        {
            ...
            Vector3 bodyInertia = new Vector3(
                (vehicleDimensions.y * vehicleDimensions.y + vehicleDimensions.z * vehicleDimensions.z) * 0.025f * mass * xCoeff,
                (vehicleDimensions.z * vehicleDimensions.z + vehicleDimensions.x * vehicleDimensions.x) * 0.05f * mass * yCoeff,
                (vehicleDimensions.x * vehicleDimensions.x + vehicleDimensions.y * vehicleDimensions.x) * 0.015f * mass * zCoeff
            );
