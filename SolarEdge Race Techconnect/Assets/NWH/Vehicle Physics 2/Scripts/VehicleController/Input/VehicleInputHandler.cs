...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public partial class VehicleInputHandler : VehicleComponent
    {
        ...
        public bool applyDeadzoneToSteering = false;
        ...
        public override void Update()
        {
            ...
            if (applyDeadzoneToSteering) states.steering = states.steering <= deadzone && states.steering >= -deadzone ? 0 : states.steering;
